...
(function() {
  ...
  */
  ...
  root.makeContractsExports = function(moduleName, original) {
    var handler;
    if (original == null) original = {};
    handler = idHandler(original);
    handler.set = function(r, name, value) {
      var originalContract, originalValue, _ref;
      _ref = contract_orig_map.get(value), originalValue = _ref.originalValue, originalContract = _ref.originalContract;
