  ...
  */
      ...
      makeHandler = function(dom, rng, options) {
        ...
        return functionHandler = function() {
          ...
          while (i < max_i) {
            ...
            if (i < arguments.length) args[i] = checked;
            i++;
          }
  ...
  object = function(objContract, options, name) {
    ...
    c = new Contract(objName(objContract), "object", function(obj, pos, neg, parentKs) {
      var contractDesc, handler, invariant, nonObject, objDesc, op, parents, prop, proto, that, value, _ref, _ref2;
      ...
      if (typeof obj === "function") {
        ...
        proto = (obj != null ? (_ref2 = obj.constructor) != null ? _ref2.prototype : void 0 : void 0) || Object.prototype;
