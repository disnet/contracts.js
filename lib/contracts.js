...
(function() {(function() {
  ...
  */
  ...
  var Contract, ModuleName, Unproxy, Utils, and_, any, arr, blame, blameM, check, checkOptions, ctor, ctorSafe, enabled, findCallsite, fun, getModName, guard, idHandler, none, not_, object, opt, or_, root, self, unproxy, ___, _blame;
  var __hasProp = Object.prototype.hasOwnProperty;

  root = typeof exports !== "undefined" && exports !== null ? exports : this.Contracts = {};
  ...
  root.Undefined = combinators.check((function(x) {
    return void 0 === x;
  }), "Undefined");

  root.Null = combinators.check((function(x) {
    return null === x;
  }), "Null");

  root.Num = combinators.check((function(x) {
    return typeof x === "number";
  }), "Num");

  root.Bool = combinators.check((function(x) {
    return typeof x === "boolean";
  }), "Bool");

  root.Str = combinators.check((function(x) {
    return typeof x === "string";
  }), "Str");

  root.Odd = combinators.check((function(x) {
    return (x % 2) === 1;
  }), "Odd");

  root.Even = combinators.check((function(x) {
    return (x % 2) !== 1;
  }), "Even");

  root.Pos = combinators.check((function(x) {
    return x >= 0;
  }), "Pos");

  root.Nat = combinators.check((function(x) {
    return x > 0;
  }), "Nat");

  root.Neg = combinators.check((function(x) {
    return x < 0;
  }), "Neg");

  root.Arr = combinators.object({
